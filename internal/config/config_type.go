...
var VMC = Config{
	...
	Sound: sound_config.Config{
		...
		MoneyIn:       "moneyIn.mp3",
		Disabled:      false,
		TTSExec:       []string{"/home/vmc/vender-db/audio/tts/piper", "--model", "/home/vmc/vender-db/audio/tts/ruslan/voice.onnx", "--config", "/home/vmc/vender-db/audio/tts/ruslan/voice.json"},
	},
